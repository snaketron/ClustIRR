...
test_that("check_dataframe_colnames() takes only valid chain combinations", {
  ...
  expect_error(check_dataframe_colnames(s), 
               regexp = "CDR3a/b can't be mixed with CDR3d/g columns")
  s <- base::data.frame("CDR3a" = c("CATSRLEFAQYF", "CATSRLEARATYF"),
                        "CDR3g" = c("CATSRLEFAQYF", "CATSRLEARATYF"))
  expect_error(check_dataframe_colnames(s), 
               regexp = "CDR3a/b can't be mixed with CDR3d/g columns") 
  s <- base::data.frame("CDR3b" = c("CATSRLEFAQYF", "CATSRLEARATYF"),
                        "CDR3d" = c("CATSRLEFAQYF", "CATSRLEARATYF"))
  expect_error(check_dataframe_colnames(s), 
               regexp = "CDR3a/b can't be mixed with CDR3d/g columns")
  s <- base::data.frame("CDR3b" = c("CATSRLEFAQYF", "CATSRLEARATYF"),
