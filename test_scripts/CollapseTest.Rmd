...
---
title: "Test v3 collapse to one node"
output:
  html_document:
    df_print: paged
---
...
# gamma clones + motifs
clone1_g <- data.frame(CDR3g = rep("CATSRLEFAQYF", times = 2))
...
# delta clones + motifs
clone1_d <- data.frame(CDR3d = rep("CAWNQEEETYEQYF", times = 4))
clone2_d <- data.frame(CDR3d = rep("CAWNQEETTYEQYF", times = 15)) #CAWNQEETRTYEQYF
...
# gamma chain
plot_graph(out3_g)
plot_graph(out3_g, expand_clones = TRUE)
# delta chain
plot_graph(out3_d)
plot_graph(out3_d, expand_clones = TRUE)
# beta & alpha chain
plot_graph(out3)
...
# gamma chain
plot_graph(out2_g)
plot_graph(out2_g, expand_clones = TRUE)
# delta chain
plot_graph(out2_d)
plot_graph(out2_d, expand_clones = TRUE)
# beta & alpha chain
plot_graph(out2)
plot_graph(out2, expand_clones = TRUE)
```
...
# gamma chain
plot_graph(out1_g)
plot_graph(out1_g, expand_clones = TRUE)
# delta chain
plot_graph(out1_d)
plot_graph(out1_d, expand_clones = TRUE)
# beta & alpha chain
plot_graph(out1)
plot_graph(out1, expand_clones = TRUE)
```
