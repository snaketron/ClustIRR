...
# add the artificial clonal expansion
clone <- data.frame(CDR3b = rep("CATSRLEFAQYF", times = 13))
data_sample <- rbind(data_sample, clone)

clone2 <- data.frame(CDR3b = rep("CATSRLEARATYF", times = 7))
data_sample <- rbind(data_sample, clone2)

clone3 <- data.frame(CDR3b = rep("CATSEEEFAQYF", times = 2))
data_sample <- rbind(data_sample, clone3)
