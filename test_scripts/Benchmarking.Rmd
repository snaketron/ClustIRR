...
# turboGLiph (turbo_gliph + gliph2 + gliph_combined)
cluster_min_size <- 1 
accept_sequences_with_C_F_start_end <-TRUE
structboundaries <- TRUE
min_seq_length <- 8 # turbo_gliph default, but not gliph2 default
boost_local_significance <- FALSE # gliph2 TRUE, gliph_combinded FALSE
...
lcminp <- control_input$local_max_fdr
lcminove <- control_input$local_min_ove
motif_distance_cutoff <- control_input$global_max_dist
kmer_mindepth <- control_input$local_min_o
accept_sequences_with_C_F_start_end <- accept_sequences_with_C_F_start_end
min_seq_length <- min_seq_length
structboundaries = structboundaries
boundary_size <- control_input$trim_flank_aa
motif_length <- ks
# discontinuous_motifs = FALSE   # default
# local_similarities = TRUE      # default
# global_similarities = TRUE     # default
# global_vgene = FALSE           # default
# all_aa_interchangeable = FALSE # default
...
boundary_size <- control_input$trim_flank_aa
# local_similarities = TRUE      # default
# local_method = "rrs"           # default
lcsim_depth <- B
motif_length <- ks
# motif_distance_cutoff = 3      # default  
lcminp <- control_input$local_max_fdr
lcminove <- control_input$local_min_ove
lckmer_mindepth <- control_input$local_min_o
# discontinuous_motifs = FALSE   # default
boost_local_significance <- boost_local_significance
# cdr3_len_stratify = FALSE      # default   
# vgene_stratify <- FALSE        # default
# global_similarities = TRUE     # default
# global_method = "cutoff"       # default
gccutoff <- control_input$global_max_dist
# gcminp = 1                     # default
gcminove <- control_input$local_min_ove
gckmer_mindepth <- control_input$local_min_o
# all_aa_interchangeable = FALSE # default
# clustering_method = "GLIPH1.0" # default
# vgene_match = "none"           # default
# public_tcrs = "all"            # default
cluster_min_size <- cluster_min_size
#scoring_method = "GLIPH1.0"     # default
scoring_sim_depth <- B
# hla_cutoff = 0.1               # default
n_cores <- cores
