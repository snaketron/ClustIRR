...
out_v1 <- cluster_irr(data_sample = data_sample_exp,
                data_ref = data_ref,
                ks = ks,
                cores = cores,
                version = 1,
...
out_v2 <- cluster_irr(data_sample = data_sample_exp,
                data_ref = data_ref,
                ks = ks,
                cores = cores,
                version = 2,
...
out_v3 <- cluster_irr(data_sample = data_sample_exp,
                data_ref = data_ref,
                ks = ks,
                cores = cores,
                version = 3,
...
names(all_versions) <- c("motif", "v1_mean_f_ref", "v1_min_f_ref", 
                         ...
                         "gt_f_ref", "gt_n_ref", 
                         "gt_f_sample", "gt_n_sample", "gt_ove",
                         "gt_f_sample_exp", "gt_n_sample_exp", "gt_ove_exp")
