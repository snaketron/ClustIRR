...
f_sample_e <- data.frame(motif=names(f_sample_e), 
                           f_sample_e=as.numeric(f_sample_e))
...
gt_motifs_e$ove <- (gt_motifs_e$f_sample_e / 
                            gt_motifs_e$n_sample_e) / 
  (gt_motifs_e$f_ref / gt_motifs_e$n_ref)


rm(f_ref, f_ref_e, f_sample, f_sample_e)
...
rm(df, fr_v1, fr_v1e, fr_v2, fr_v2e, fr_v3, fr_v3e,
   ...
   nr_v1, nr_v1e, nr_v2, nr_v2e, nr_v3, nr_v3e,
   ns_v1, ns_v1e, ns_v2, ns_v2e, ns_v3, ns_v3e,
