...
-   `weight`: "nweight" (default) or "ncweight"
...
### **Quantitative** similarity between community abundance vectors with `get_community_cosine_similarity`
...
cos_sim <- get_community_cosine_similarity(com = gcd$community_occupancy_matrix)
cos_sim$g
```
