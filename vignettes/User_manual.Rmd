...
Furthermore, we can "decompose" this graph using `decode_community` based
on the attributes of the edges (`edge_filter`) and nodes (`node_filter`).
...
edge attributes: nweight>=3 **AND** ncweight>=3
