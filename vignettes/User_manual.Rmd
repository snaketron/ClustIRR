...
`ks` = 4 and compute two outputs for *version 2* and *version 3*, trimming the 
flank amino acids by three on each side.
...
other sequences (`f_ref` > 0), and in this case, by chance, one of them 
(*GLAA*) was contained in the sample before the artificial enhancement, leading
to a count of 31. 
