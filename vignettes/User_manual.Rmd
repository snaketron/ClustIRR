...
patchwork::wrap_plots(o$violins)
```



Which communities have TCR clones with CMV, EBV and Influenza-specific CDR3s?

```{r}
cs_ann <- get_community_ann(community_summary = gcd$community_summary,
