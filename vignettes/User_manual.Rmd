...
We start by loading the `r Biocpkg("ClustIRR")` and the *knitr* package.
...
found by *version 2*, also 15 motifs of the clonally expanded sequences 
...
```{r local_motifs_output_version_3, width = 5}
