...
```{r, fig.width=5, fig.height=4, fig.align='center'}
vis_g <- plot_graph(clust_irr = o, as_visnet = TRUE)
vis_g
```
...
Finally, you might want to focus on only the large connected vertices 
in the graph. You can accomplish this by setting the input parameter 
