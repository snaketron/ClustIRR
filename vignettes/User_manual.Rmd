...
To remove all vertices without edges from the graph, we can disable the option *show_singletons*. This does not remove vertices with clone_size bigger than 1.
