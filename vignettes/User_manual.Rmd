...
*Version 2* marks six motifs as enriched, while *version 3* finds 20 - the same
6 that *version 2* finds plus 14 additional motifs between the clonally 
expanded sequences.
...
CDR3 sequences sharing enriched local motifs are listed as data.frame with 
columns .


```{r local_edges_output}
# global motifs version 2
e <- get_edges(clustirr_output_v2)
